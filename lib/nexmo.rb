...
require 'nexmo/responses/response'
require 'nexmo/responses/list_response'
require 'nexmo/responses/number_insight_response'
require 'nexmo/responses/numbers_response'
require 'nexmo/responses/sms_response'
require 'nexmo/responses/verify_response'
